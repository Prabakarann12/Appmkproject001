                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Text(
                        "Discover programs",
                        style: TextStyle(fontSize: 20.0,color: themeNotifier.themeMode == ThemeMode.dark ? Colors.white : Colors.black,),
                      ),
                    ),
                    Expanded(
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            ListTile(
                              title: Text("Connection",style: TextStyle(color: themeNotifier.themeMode == ThemeMode.dark ? Colors.white : Colors.black,),),
                            ),
                            SizedBox(
                              height: 105,
                              child: ListView.builder(
                            ...
                            ListTile(
                              title: Text("My Profile",style: TextStyle(color: themeNotifier.themeMode == ThemeMode.dark ? Colors.white : Colors.black,),),
                            ),
                            Center(
                              child: Container(
                                height: 240 * 0.97,
